(define (problem hanoi-8)
  (:domain hanoi-domain)
  (:objects p1 p2 p3 d1 d2 d3 d4 d5 d6 d7 d8)
  (:init 
    ...
    (disk d1)(disk d2)(disk d3)(disk d4)(disk d5)(disk d6)(disk d7)(disk d8)
    (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 d7)(on d7 d8)(on d8 p3)
  )
  (:goal 
    (and (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 d7)(on d7 d8)(on d8 p1) )
  )
)
