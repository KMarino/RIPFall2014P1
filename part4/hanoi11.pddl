(define (problem hanoi-12)
  (:domain hanoi-domain)
  (:objects p1 p2 p3 d1 d2 d3 d4 d5 d6 d7 d8 d9 d10 d11)
  (:init 
    ...
    (smaller d11 p1)(smaller d11 p2)(smaller d11 p3)
    ...
    (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 d7)(on d7 d8)(on d8 d9)(on d9 d10)(on d10 d11)(on d11 p3)
  )
  (:goal 
    (and (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 d7)(on d7 d8)(on d8 d9)(on d9 d10)(on d10 d11)(on d11 p1) )
  )
)
